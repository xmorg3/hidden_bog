...
{//gc->wall_all
  ...
  if( right ==2 || right == 3)  {SDL_RenderCopy(gc->renderer, gc->wall_right_fov2_blank, NULL, &gc->player_viewport);}
  if( right == 4) {
  ...
  if( middle==2 || middle ==3)  {SDL_RenderCopy(gc->renderer, gc->wall_front_fov1_blank, NULL, &gc->player_viewport);}
  if( middle==4)  {
...
void draw_fov0(GameCore *gc, int left, int middle, int right)
{
  ...
  if( middle==2 || middle ==3)  {SDL_RenderCopy(gc->renderer, gc->wall_left_fov0_blank, NULL, &gc->player_viewport);}
  if( left == 4)  {
  ...
  if( middle==2 || middle ==3)  {SDL_RenderCopy(gc->renderer, gc->wall_right_fov0_blank, NULL, &gc->player_viewport);}
  if( right == 4)  {
